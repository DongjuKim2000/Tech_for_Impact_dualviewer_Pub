...
fun getGlucoseTrend(glucoseData: List<BG>): String {
    ...
    val timeDifferenceMinutes_2 = timeDifferenceMillis_2 / (1000 * 60)
    ...
    return when {
        ...
        rateOfChange in 1.0..2.0 || changeIn30Mins in 30.0..59.0 -> "↗"
        rateOfChange in -1.0..1.0 && changeIn30Mins in -59.0..59.0 -> "→"
        rateOfChange in -3.0..-2.0 || changeIn30Mins in -90.0..-60.0 -> "↘"
        rateOfChange in -2.0..-1.0 || changeIn30Mins in -59.0..-30.0 -> "↓"
        rateOfChange < -3 || changeIn30Mins < -90 -> "⇊"
        else -> "XX"
    }
}
